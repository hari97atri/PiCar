...
def image_result(image_path):
    ...
    a_left=angles_left(hough_avg_left)
    ...
    a_right=angles_right(hough_avg_right)
    
   
    cv2.imwrite('C:/Users/VEW1KOR/Desktop/autosar+can/final_image_left.jpeg',original_image_with_hough_lines_left)
    cv2.imwrite('C:/Users/VEW1KOR/Desktop/autosar+can/final_image_right.jpeg',original_image_with_hough_lines_right)
